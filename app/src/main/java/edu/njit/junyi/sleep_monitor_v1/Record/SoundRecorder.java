...
//    private final static String TAG = "Sleep_Monitor";
//
...
//        wakeLock = mgr.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "Sleep Monitor");
//        wakeLock.acquire();
//
...
//        audioRecorder = new AudioRecorder(soundModel,null);
//        audioRecorder.start();
//
